...
![bg right contain](./centripetal-force.png)
...
![bg right contain](./descending-turn.jpg)
...
<table width="100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Uncoordinated use of controls</td>
            <td>Slip or skid</td>
            <td>Monitor balance ball during perf check</td>
        </tr>
        <tr>
            <td>Overbank tendency</td>
            <td>Fixate on instruments<!-- or other distraction --></td>
            <td>Spiral dive</td>
            <td>
                <!--
                    Attitude flying – eyes outside 90% of the time
                    Recover:
                        Power idle
                        Wings level with coordinated aileron and rudder
                        Slowly pull out of the dive
                        Once level re-introduce cruise power
                -->
            </td>
        </tr>
    </tbody>
...
<table width="100%">
    ...
    <tbody>
        ...
        <tr>
            <td>Overbank tendency</td>
            <td>Fixate on instruments</td>
            <td>Spiral dive</td>
            <td>
                90% eyes outside<br />
                Recover: idle, wings level, slowly pull up
            </td>
        </tr>
    </tbody>
</table>
